...
<head>
    ...
    <title>DVJR Rent Cars | Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        {{-- Flash message --}}
        @if(session('success'))
        <div class="session-alert alert alert-success alert-dismissible fade show" role="alert">
        ...
        @if(session('error'))
        <div class="session-alert alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <!-- Scripts (jQuery dulu, lalu Bootstrap) -->
